...
const journeyData = [
  ...
  },
  {
    ...
    achievements: ["Current CGPA: 8.32"],
    icon: GraduationCap,
    color: "",
  },
]
...
export default function Experience() {
  return (
    <section id="experience" className="py-20 px-6 bg-background scroll-mt-24 relative overflow-hidden">
      {/* ambient background */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-normal text-foreground mb-4">Experience</h2>
          <p className="text-foreground/70 text-lg max-w-2xl mx-auto font-light">
            My professional experience and education that shaped my journey.
          </p>
        </div>
                  ...
                  <Card className="card-gradient backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 border border-border/20 group relative overflow-hidden">
                    ...
                    <CardHeader className="relative z-10">
                      ...
                      <div className="flex items-center text-foreground/70 mb-2">
                        {"organizationUrl" in item && (item as any).organizationUrl ? (
                          <a
                            href={(item as any).organizationUrl as string}
                            target="_blank"
                          ...
                          <span className="font-medium">{(item as any).organization}</span>
                        )}
